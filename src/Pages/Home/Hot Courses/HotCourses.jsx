...
const HotCourses = () => {
    ...
    useEffect(()=>{
        fetch('https://edu-verse-server-site-rifat-ahmeds-projects-07d383b5.vercel.app/learnToday')
        .then(res =>  res.json())
        .then(data =>{
            setCourses(data)
    ...
    return (
        <div  className='w-11/12 mx-auto mt-3 md:mt-6 mb-3 md:mb-6'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-3 md:gap-4">
